...
class PhoneDetailsFragment : Fragment() {
    ...
    private lateinit var viewModel: PhoneDetailsViewModel

    companion object {

        private const val PHONE_ID_KEY = "PHONE_ID"

        fun newInstance(phoneId: Int): PhoneDetailsFragment {

            return PhoneDetailsFragment().apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, ViewModelFactoryUtil.viewModelFactory {
            PhoneDetailsViewModel(PhonesDataSource(ApiServiceProvider.phonesApiService))
        }).get(PhoneDetailsViewModel::class.java)
